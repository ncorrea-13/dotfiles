...
cp -r btop ~/Projects/things/dotfiles/.config/
cp -r fastfetch ~/Projects/things/dotfiles/.config/
cp -r wezterm ~/Projects/things/dotfiles/.config/
cp -r zellij ~/Projects/things/dotfiles/.config/
cp -r cava ~/Projects/things/dotfiles/.config/
cp -r nvim ~/Projects/things/dotfiles/.config/
